...
public abstract class AbstractSwitchFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        FloatingActionButton newBtn = view.findViewById(R.id.switchAdd);
        ...
        RecyclerView mRecycler = view.findViewById(R.id.switchList);
...
//        super.onActivityCreated(savedInstanceState);
        ...
        FirebaseRecyclerOptions<Switch> options = new FirebaseRecyclerOptions.Builder<Switch>()
